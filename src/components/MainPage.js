                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="align-middle">
                                ...
                                <h4 class="table-text"><img src="wazix.png" class="exchange-logo"/> <span class="exchange-name ">WazirX</span></h4>
                                </a>
                            </td>
                            <td class="align-middle"><h4 class="table-text">₹ 1,79,500</h4></td>
                        ...
                        <tr>
                            ...
                            <td class="align-middle"><a target="_blank" href=" "><h4 class="table-text">
                                <img src="giotus.png" class="exchange-logo" /><span class="exchange-name ">Giotus</span></h4></a>
                            </td>
                            <td class="align-middle"><h4 class="table-text">₹ 1,79,000</h4></td>
                            <td class="align-middle"><h4 class="table-text"><span>₹ 1,78,010 / ₹ 1,79,000</span></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="align-middle"><a target="_blank" href=""><h4 class="table-text">
                                <img src="zebpay.png" class="exchange-logo" /><span class="exchange-name">Zebpay</span></h4></a>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="align-middle"><a target="_blank" href=" "><h4 class="table-text">
                                <img src="coibdcx.png" class="exchange-logo" /><span class="exchange-name">CoinDCX</span></h4></a>
                            </td>
