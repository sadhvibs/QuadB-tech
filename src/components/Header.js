...
export const Header = (props) => {
    ...
    return (
        <div style={{padding: "20px 30px 0px"}}>
            <div class=" align-items-center justify-content-sm-center row">
                ...
                <div class="text-center padding-none col-12 col-sm-12 col-md-2 col-lg-4">
                    ...
                    <ButtonDropdown isOpen={dropdownOpenCurrency} toggle={toggleCurrency} >
                        <DropdownToggle caret className={"header-button"}>{currency}
                        </DropdownToggle>
                        <DropdownMenu >
                    ...
                    <DropdownToggle caret className={"header-button"}> {asset}</DropdownToggle>
                    <DropdownMenu>
                        ...
                        <DropdownItem value="XEM" onClick={(e) => setAsset(e.target.value)}>XEM</DropdownItem>
            ...
            <div class="right-header col-xs-12 col-sm-12 col-md-5 col-lg-4">
                <div class="d-inline-flex flex-wrap align-items-center justify-content-center">
                {!this.props.hideAssetCurrencyButtons && (
                    <div className="progress-bar-wrapper">
                        <CircularProgressbar  value={parseFloat(this.props.countDownTimer * 100 / 60.0)} text={`${props.countDownTimer}`}/>
                    </div>
                )}
                    ...
                    <a class="color-white" href="/connect/telegram">
                        <div class="d-flex telegram-logo-text header-telegram-button btn align-items-center pointer color-white">
                            ...
                            <div class="text-nowrap d-inline-block color-white"> Connect Telegram
                            </div>
                        </div>
                    </a>
                    <div className="margin-10 d-inline-block">
                        <label className="switch">
                           <input type="checkbox" checked={!this.props.isLightTheme} onChange={this.props.onThemeButtonClick} />
